...
<body>
    ...
    <button class="btn btn-primary my-5"><a href="c2upload.php" class="text-light">Add video</a>
    </button>
    <div class="">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    '<tr>
                        ...
                        <td>
                        <button class="btn btn-success"><a href="c2update.php?
                        updateid=' . $id . '" class="text-light" >Update</a></button>
                        <button class="btn btn-danger" ><a href="c2delete.php?
