...
if (isset($_POST['submit'])) {
    ...
    $sql = "update `admin` set id='$id',username='$username',gender='$gender'
    ,mobile='$mobile',email='$email',password='$password'
    where id=$id";
    $result = mysqli_query($conn, $sql);
    if ($result) {
        header('location:admin_record.php?mess=Successfully Updated');
    } else {
                ...
                <div class="col-md-12">
                    <form method="POST" class="my-5">
                        ...
                        <div class="form-floating mb-3">
                            <input type="name" class="form-control" id="floatingInput" placeholder="name" name="username" value="<?php echo $username; ?>">
